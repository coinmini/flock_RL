...
@click.option('--local-model-path', envvar='LOCAL_MODEL_PATH', default=None, type=str, help='Local model file path (skip HuggingFace download)')
@click.option("--debug", is_flag=True)
def main(module: str, task_ids: str, flock_api_key: str, hf_token: str, time_sleep: int, assignment_lookup_interval: int, local_model_path: str, debug: bool):
    """
